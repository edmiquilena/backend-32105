...
const objNorm = normalize(empresa, organigramaSchema);

const objDeNorm = denormalize(
  objNorm.result,
  organigramaSchema,
  objNorm.entities
);
...
console.log(`Longitud normalizado: ${JSON.stringify(objNorm).length}`);
console.log(`Longitud denormalizado: ${JSON.stringify(objDeNorm).length}`);
